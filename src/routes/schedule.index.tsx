      ...
      <div className="min-h-screen">
        ...
        <div className="relative py-16 px-6 bg-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-gray-100 border border-gray-200 text-gray-600 text-sm font-medium">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-4 tracking-tight">
              Conference <span className="text-gray-400 italic">Schedule</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 mb-12 mt-12">
          <div className="flex justify-center">
            <div className="inline-flex bg-gray-100 rounded-2xl p-2 border border-gray-200">
        ...
        <div className="max-w-7xl mx-auto px-6 mb-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-2">
              ...
              <span className="text-gray-400 italic">{currentDayData.theme}</span>
            </h2>
            <p className="text-gray-500">{currentDayData.date}</p>
          </div>
        </div>
                  ...
                  >
                    <div className="relative flex gap-6 md:gap-10">
                      ...
                      <div className="flex-shrink-0 w-16 md:w-24 pt-6">
                        <div className="relative">
                          {/* Timeline dot */}
                          <div className="absolute -right-[13px] md:-right-[17px] top-0 w-6 h-6 rounded-full bg-white border-4 border-black flex items-center justify-center group-hover:scale-110 transition-all z-10" />
                          <span className="block text-right text-sm md:text-base font-semibold text-gray-500 group-hover:text-black transition-colors">
                            {session.time}
                          </span>
                        </div>
                      </div>
                      ...
                      {/* Session card */}
                      <div
                        className="flex-1 relative overflow-hidden rounded-2xl bg-white border border-gray-200 
                          group-hover:border-gray-300 transition-all duration-300 group-hover:shadow-lg
                        ...
                        <div className="relative p-6 md:p-8 flex flex-col md:flex-row gap-6 items-start">
                          ...
                          {speaker && (
                            <div className="flex-shrink-0">
                              <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-xl overflow-hidden border border-gray-200 shadow-sm group-hover:shadow-md transition-all">
                                <img
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap gap-2 mb-3">
                              {talk.topics.slice(0, 3).map((topic) => (
                                <span
                                  key={topic}
                                  className="px-2.5 py-0.5 text-xs font-medium tracking-wide uppercase bg-gray-100 text-gray-600 border border-gray-200 rounded-full"
                                >
                                  {topic}
                                </span>
                              ))}
                            ...
                            {/* Title */}
                            <h3 className="text-xl md:text-2xl font-bold text-gray-900 group-hover:text-black transition-colors mb-2 leading-tight">
                              {talk.title}
                            </h3>
                          ...
                          <div className="flex-shrink-0 self-center">
                            <div className="w-10 h-10 rounded-full bg-gray-50 border border-gray-200 flex items-center justify-center group-hover:bg-black group-hover:border-black transition-all">
        ...
        <div className="max-w-4xl mx-auto px-6 pb-20">
          <div className="relative p-8 md:p-12 rounded-3xl bg-gray-50 border border-gray-200 overflow-hidden text-center">
            <div className="relative">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link
                  to="/talks"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-black text-white font-semibold transition-all hover:bg-gray-800 hover:shadow-lg"
                >
                  Browse All Sessions
                </Link>
                <Link
                  to="/speakers"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-gray-300 text-gray-700 font-semibold transition-all hover:bg-white hover:border-gray-400"
                >
                  Meet the Speakers
                </Link>
              </div>
