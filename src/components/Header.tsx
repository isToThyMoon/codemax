...
export default function Header() {
  ...
  return (
    <>
      <header className="p-4 flex items-center bg-white/80 backdrop-blur-md text-gray-900 border-b border-gray-200 sticky top-0 z-50">
        <button
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-80 bg-white text-gray-900 border-r border-gray-200 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
      ...
      >
        ...
        <nav className="flex-1 p-4 overflow-y-auto">
          <Link
            ...
            activeProps={{
              className:
                'flex items-center gap-3 p-3 rounded-lg bg-black text-white hover:bg-gray-800 transition-colors mb-2',
            }}
          >
            <Home size={20} />
          ...
          <div className="flex flex-row justify-between">
            <Link
              to="/demo/start/ssr"
              onClick={() => setIsOpen(false)}
              className="flex-1 flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 transition-colors mb-2"
              activeProps={{
                className:
                  'flex-1 flex items-center gap-3 p-3 rounded-lg bg-black text-white hover:bg-gray-800 transition-colors mb-2',
              }}
            >
              <StickyNote size={20} />
